...
| Version | `VERSION_NOT_FOUND`, `IMMUTABLE_RESOURCE`, `DOCUMENT_UNPUBLISHED`, `PUBLISH_BASE_STALE` | 404, 409, 409, 409 | `baseVersionId`, `currentVersionId`, `draftId` |
...
| Public | `PUBLIC_LINK_INVALID`, `PUBLIC_LINK_STATE_INVALID`, `PUBLIC_LINK_TOKEN_ALREADY_ISSUED` | 404, 409, 409 | 없음 |
...
| Review | `REVIEW_NOT_FOUND`, `REVIEW_ALREADY_OPEN`, `REVIEW_STALE`, `REVIEW_STATE_INVALID`, `REVIEW_NOT_ELIGIBLE` | 404, 409, 409, 409, 403 | `draftRevision`, `currentStatus` |
| Inbox | `INBOX_ITEM_NOT_FOUND` | 404 | 없음 |
| Knowledge | `SEARCH_UNAVAILABLE`, `SEARCH_CURSOR_EXPIRED`, `REFERENCE_TARGET_INVALID`, `REFERENCE_NOT_FOUND`, `VOCABULARY_TERM_CONFLICT`, `VOCABULARY_NOT_FOUND`, `VOCABULARY_STATE_INVALID` | 503, 409, 422, 404, 409, 404, 409 | `configurationVersion`, `term` |
| AI | `AI_CONTEXT_STALE`, `AI_CONTEXT_LIMIT_EXCEEDED`, `AI_QUOTA_EXCEEDED`, `AI_CONCURRENCY_LIMIT`, `AI_JOB_NOT_FOUND`, `AI_JOB_STATE_INVALID`, `AI_OUTPUT_LIMIT_EXCEEDED`, `AI_RESULT_INVALID`, `AI_RESULT_STALE`, `AI_RESULT_RULE_BLOCKED`, `PROPOSAL_NOT_FOUND`, `PROPOSAL_STALE`, `PROPOSAL_STATE_INVALID`, `PROPOSAL_DEPENDENCY_INVALID` | 409, 422, 429, 429, 404, 409, 422, 422, 409, 422, 404, 409, 409, 422 | `limit`, `resetAt`, `baseRevision` |
