...
| AI | `AI_CONTEXT_STALE`, `AI_CONTEXT_LIMIT_EXCEEDED`, `AI_QUOTA_EXCEEDED`, `AI_CONCURRENCY_LIMIT`, `AI_JOB_NOT_FOUND`, `AI_JOB_STATE_INVALID`, `AI_OUTPUT_LIMIT_EXCEEDED`, `PROPOSAL_NOT_FOUND`, `PROPOSAL_STALE`, `PROPOSAL_STATE_INVALID` | 409, 422, 429, 429, 404, 409, 422, 404, 409, 409 | `limit`, `resetAt`, `baseRevision` |
